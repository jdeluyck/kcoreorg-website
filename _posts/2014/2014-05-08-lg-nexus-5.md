...
Since my old HTC Hero, I've been replacing the look set by the vendor by a more stock Google Android look. So it makes only sense that my last phone should be a Google-commissioned [Nexus](https://en.wikipedia.org/wiki/Google_Nexus) device, namely the [LG](https://www.lg.com/be_nl) [Nexus 5](https://en.wikipedia.org/wiki/Nexus_5). In black, ofcourse ;)

So, replacing the [HTC One X](https://en.wikipedia.org/wiki/HTC_One_X), here's my new daily use phone:

[![LG Nexus 5](/assets/img/posts/2014/05/lg-google-nexus-5-1.jpg "LG Nexus 5")](http://www.gsmarena.com/lg_nexus_5-5705.php)
