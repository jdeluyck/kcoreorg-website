...
- Maximizing doesn't. If I hit that button, I expect the window to *maximize* over the entire screen. Not so with macOs, it'll just do something weird like maximize to content. Which is not what I want.
