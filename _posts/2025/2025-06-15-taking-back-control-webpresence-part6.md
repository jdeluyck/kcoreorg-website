...
Other players that I've dabbled with in the past are [SourceForge](https://sourceforge.net/), [GitLab](https://about.gitlab.com/), [BitBucket](https://bitbucket.org), [Gitea](https://about.gitea.com/) and lately [CodeBerg](https://codeberg.org/) and it's counterpart [Forgejo](https://forgejo.org/).
