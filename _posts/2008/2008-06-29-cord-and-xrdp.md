...
I was trying to get [xrdp](http://www.xrdp.org/) running on my Linux box, so I could takeover the screen from the outside world. The [rdp protocol](https://en.wikipedia.org/wiki/Remote_Desktop_Protocol) is a (huge) bit more performant than [VNC](https://en.wikipedia.org/wiki/Vnc), which is why I wanted to use it.
