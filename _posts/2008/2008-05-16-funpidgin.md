...
Thanks to a [post](https://blog.futtta.be/2008/05/16/linux-distros-en-ssh-bugs-in-beeld/) on [Frank Goosens' blog](https://blog.futtta.be/) I discovered [FunPidgin](http://funpidgin.sf.net)! A fork of [Pidgin](https://www.pidgin.im/), a multi-messenger client formerly known as Gaim.
