...
* WiFi accesspoints & passwords ([if this is a good thing](https://arstechnica.com/information-technology/2013/07/does-nsa-know-your-wifi-password-android-backups-may-give-it-to-them/), is another question)
...
For a full overview what you can do with bmgr, see [the android developer webpage](https://developer.android.com/tools/bmgr).
