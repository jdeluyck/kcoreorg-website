...
A little while back I finally caved in to all the peer pressure and got my second Android phone, the [HTC Desire](https://en.wikipedia.org/wiki/HTC_Desire). It's faster than the HTC Hero, which I've been using sofar. My girlfriend wanted that one, so it'll have a good home :) and I can keep it updated to the latest firmwares.

One of the first things I did was root it with [Unrevoked](https://web.archive.org/web/20100605013342/http://unrevoked.com:80/)[^ia1] - a nice one-stop-shop rooting tool, which also installs the [Clockworkmod](https://www.clockworkmod.com/) recovery, through which you can then install other ROMs.  
...
Unfortunately, there wasn't much development on this ROM, and I went looking for another after a while, and stumbled over Richard Trip's [DeFrost](https://xdaforums.com/t/rom-froyo-aosp-cyanogenmod-defrost-6-1a-12-12-havs-fm-mods-ota.690477/) ROM, which is based on [CyanogenMod](https://en.wikipedia.org/wiki/CyanogenMod) with some extra goodies in it.
