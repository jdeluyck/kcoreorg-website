...
In the original design of my [Proxmox box](/2020/05/07/enter-zfs/) I opted for running the docker containers straight on the host. For a lot of reasons, this is actually a Bad Idea™️, and it's been one of my goals to migrate these to a VM at some point.
...
You'll also have to make sure it's shared (see `/etc/exports`{: .filepath} on your NFS server)
