...
To enable search we need an [elasticsearch](https://www.elastic.co/elasticsearch) instance for our instance. [The manual](https://docs.joinmastodon.org/admin/optional/elasticsearch/) comes with instructions on how to enable this.
