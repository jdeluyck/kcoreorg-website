...
Today I went for [another testdrive](/2007/11/12/test-drive-with-toyota-prius/) with the [Toyota](https://nl.toyota.be/) [Prius](http://nl.toyota.be/cars/new_cars/prius/index.aspx), longer this time - 2 hours - to see how the car handled in all the usual traffic, and also to be able to judge the seats, the radio, the cruise control, the multi-info-display, everything.
