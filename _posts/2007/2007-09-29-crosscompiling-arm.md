...
Now, download the packages you need manually (from [www.debian.org](https://www.debian.org/distrib/packages) and extract them in the directory using `dpkg -x <package file> /usr/arm-deb`
