...
Since I sold my trusty 3-year old [Acer](https://www.acer.com/be-nl/) Travelmate 803, I was going to go and look in some stores for new laptops. Hopping around in Ghent, I walked off to the [Fnac](http://www.fnac.be), noted the offers there (nothing that really drew my attention), and then to the [Switch](https://web.archive.org/web/20070106185906/http://www.switchshops.be:80/)[^ia1] computer store (an authorized mac reseller). Their non-mac offerings are not too great (you can better go to another store), so I waited my turn at the counter, and when it was my time I asked for some more information about Macs and Mac OS X.
...
[^ia1]: Internet Archive snapshot. Original URL: http://www.switchshops.be <!-- markdownlint-disable-line MD034 -->
