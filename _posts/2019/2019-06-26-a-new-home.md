...
I've also moved this blog from my old hosting on [Gandi.net](https://www.gandi.net/) to an [AWS Serverless](https://aws.amazon.com/serverless/) setup (more on that in the future).
